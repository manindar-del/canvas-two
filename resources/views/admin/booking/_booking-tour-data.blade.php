    ...
    <div class="_status__info">
        ...
        @if( $booking->is_paid)
            <div class="col-xs-12 text-center">
                <a href="{{ route('bookingadmin.tourinvoice', [$booking->id, $_booking->BookingId]) }}" class="btn btn-danger" target="_blank">Invoice</a>&nbsp;&nbsp;
                @php
                    // dd($_booking)
                @endphp
                <a href="{{ route('bookingadmin.tourvoucher', [$booking->id, $_booking->BookingId]) }}" class="btn btn-danger" target="_blank">Voucher</a>
            </div>
        @endif
        </div>
