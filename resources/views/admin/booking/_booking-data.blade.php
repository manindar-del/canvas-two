            ...
            @if( $booking->is_paid)
                @if (!empty($_booking->BookingDetails->BookingId))
                    <div class="col-xs-12 text-center">
                        <a href="{{ route('bookingadmin.invoice', [$booking->id, $_booking->BookingDetails->BookingId]) }}" class="btn btn-danger" target="_blank">Invoice</a>&nbsp;&nbsp;
                        @php
                            // dd($_booking)
                        @endphp
                        <a href="{{ route('bookingadmin.voucher', [$booking->id, $_booking->BookingDetails->BookingId]) }}" class="btn btn-danger" target="_blank">Voucher</a>
                    </div>
                @endif
            @endif
        </div>
