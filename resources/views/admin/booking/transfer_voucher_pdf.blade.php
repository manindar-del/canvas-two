...
@endphp
	...
	<tr>
	  ...
	  <td  valign="top">
            ...
            <div class="col-xs-6"><p><b>Tel &nbsp;</b>:+66-33031058</p> </div>
            <div class="col-xs-6"><p><b>Fax &nbsp;</b>:+66-634538668</p> </div>
            <div class="col-xs-12"><p><b>Email &nbsp;</b>:online@canvasvacations.net</p></div>
                ...
                <div class="black">
                  ...
                  <div style="background-color:#929292;padding:5px;color:#FFF; font-size:20px; font-weight:bold;">transfer INFORMATION </div>
                    <div class="col-xs-12">
                    <table width="100%"  cellspacing="2" cellpadding="5" class="tbl_1">
                      ...
                      <tr>
                          ...
                          <td> {{$address}} {{ $city->name }}, {{ $country->name }}</td>
                      </tr>
                      <tr>
    ...
    before the pick time as in case if a tour is missed cannot be re-arranged.
             ...
             <div class="clearfix">&nbsp;</div>
              ...
              <div class="col-xs-12 text-center">
                  <p style="margin: 0 auto; text-align: center;">India On Tour Support : We are available 24x7 at +91-9582948053</p>
              </div>
              {{-- <div class="clearfix">&nbsp;</div> --}}
