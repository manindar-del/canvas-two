@if (!empty($_entry))
    <div class="row">
        ...
        <div class="col-lg-9 col-md-12 hotelNameDeatils">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 hotelDetails">
                    ...
                    <div class="hotelDescription">{{ strlen($_entry->details) > 25 ? substr($_entry->details, 0, 80) . '&hellip;' : $_entry->details }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-12 confirmHotelBooking text-lg-center text-md-left">
           ...
           <p> <a href="{{ route('tours.search.show', [$search_id, $_entry->id]) }}" class="btn text-capitalize">View more</a></p>
