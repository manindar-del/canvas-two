...
<div class="container">
        ...
        <p>
            <a href="{{ route('booking.transfervoucherpdf', [$booking->id, $booking_data->BookingId]) }}" class="btn ticker-btn ">Download PDF</a>
        </p>
    ...
    <div class="pdf">
        <div class="row">
            ...
            <div class="black">
                <div class="col-xs-12 ab_bgcolor text-center">
                    <h3 style="color:#FFF;">CONFIRMATION -TRANSFERS</h3>
                </div>

                <div class="clearfix">&nbsp;</div>

                <div class="col-xs-12 header_bgcolor">
